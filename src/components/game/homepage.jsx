...
import { Bars3Icon, QuestionMarkCircleIcon, MagnifyingGlassIcon, ShoppingBagIcon, XMarkIcon } from '@heroicons/react/24/outline'
import poster from '../../Assets/poster.png'
import poster2 from '../../Assets/poster2test.png'

import playstation from '../../Assets/ps5.png'
import xbox from '../../Assets/xbox.png'
import switchConsole from '../../Assets/switch.png'
...
import charitySvg from '../../Assets/money.svg'
...
const collections = [
  ...
  },
  {
    name: 'Switch Console',
    href: '#',
    imageSrc: {switchConsole},
    imageAlt: 'Switch console',
    imgName:'switchConsole'
  },
]
const trendingProducts = [
  {
    ...
    href: '#',
    imageSrc: `${pokemon}`,
    imageAlt: 'Pokemon Scarlet for nintendo switch',
  },
  {
    id: 2,
    ...
    href: '#',
    imageSrc: `${hog}`,
    imageAlt: 'Harry potter Hogwarts Legacy for PS5',
  },
  {
    id: 3,
    name: 'Final Fantasy',
    ...
    href: '#',
    imageSrc: `${ff}`,
    imageAlt: 'Final fantasy for PS5',
  },
  {
    id: 4,
    name: 'God of war',
    ...
    href: '#',
    imageSrc: `${god}`,
    imageAlt: 'Latest god of war game',
  },
...
const perks = [
  {
    name: 'Return anytime for £1 per day',
    imageUrl: `${gameSvg}`,
    description: 'Finished the game or got tired of it then return the game to us and we will offer trade taking £1 for every day you had it',
  },
  {
  ...
  },
  {
    ...
    description: 'The more you order the bigger the discount.',
  },
  {
    name: '10% to charity',
    imageUrl: `${charitySvg}`,
    description: '10% of your membership goes directly to charity and you pick it.',
  },
]
                        ...
                        {category.featured.map((item) => (
                          <div key={item.name} className="group relative">
                            <div className="aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden group-hover:opacity-75">
                              <img src={item.imageSrc} alt={item.imageAlt} className="object-center object-contain"/>
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="h-16 flex items-center justify-between">
                ...
                <div className="hidden lg:flex-1 lg:flex lg:items-center">
                  <a href="#">
                    <span className="text-gray-900 font-semibold">Nik Games</span>
                    {/* <img
                                          ...
                                          <div key={item.name} className="group relative">
                                            {/* <div className="aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden group-hover:opacity-75">
                                              <img
                                                src={item.imageSrc}
                                                alt={item.imageAlt}
                                                className="object-center object-contains"
                                              />
                                            </div> */}
                ...
                <a href="#" className="lg:hidden">
                  <span className="sr-only text-semibold text-gray-900">Nik Games</span>
                  {/* <img
      ...
      <main>
        ...
        <div className="relative">
          ...
          <div aria-hidden="true" className="hidden absolute inset-0 sm:flex sm:flex-col">
            <div className="flex-1 relative w-full opacity-100">
              <div className="absolute inset-0 overflow-hidden">
                <img
                  src={poster2}
                  alt=""
                  className="w-full h-full object-center object-cover mx-auto text-center"
                />
              </div>
          ...
          <section aria-labelledby="collection-heading" className="-mt-96 relative sm:mt-0">
            ...
            <div className="max-w-md mx-auto grid grid-cols-1 gap-y-6 px-4 sm:max-w-7xl sm:px-6 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:px-8 lg:gap-x-8">
              {collections.map((collection) => {
                const image:any = collection.imageSrc;
                return (
                    ...
                    <div>
                      <div aria-hidden="true" className="absolute inset-0 rounded-lg overflow-hidden">
                        <div className="absolute inset-0 overflow-hidden group-hover:opacity-75">
                          <img
                            src={`${image[collection.imgName]}`}
                            alt={collection.imageAlt}
                            className="w-full h-full object-center object-cover object-scale-down-50"
                          />
                        </div>
      ...
      <footer aria-labelledby="footer-heading" className="bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 md:grid-flow-col md:gap-x-8 md:gap-y-16 md:auto-rows-min">
              ...
              <div className="mt-10 col-span-6 grid grid-cols-2 gap-8 sm:grid-cols-3 md:mt-0 md:row-start-1 md:col-start-3 md:col-span-8 lg:col-start-2 lg:col-span-6">
                {/* <div className="grid grid-cols-1 gap-y-12 sm:col-span-2 sm:grid-cols-2 sm:gap-x-8">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">Games</h3>
          ...
          <div className="border-t border-gray-100 py-10 text-center">
            <p className="text-sm text-gray-500">&copy; 2023 Made by Nikita.</p>
          </div>
        </div>
      </footer>
    </div>
